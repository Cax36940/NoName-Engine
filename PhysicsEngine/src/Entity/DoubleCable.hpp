...
public:
	...
	DoubleCable(Particle* particle1, Particle* particle2, const float default_length, const float width, const glm::vec3& color) : cable(particle1, particle2, default_length), sprite(particle1->get_position_ptr(), particle2->get_position_ptr(), width, color) {}
};